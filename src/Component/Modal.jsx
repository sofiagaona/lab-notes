      ...
      <div className="box-modal">
        <form className="modal" action="" onSubmit={fnheandleSubmit}>
          <div className="box-btn-close">
            <button type="button" className="closeButton" onClick={fnClose}>
              X
            </button>
          </div>
          <input
            type="text"
            value={newTitle}
            onChange={heandleTitle}
            placeholder="Titulo"
          />
          <textarea
            type="text"
            value={newNote}
            onChange={heandleNote}
            placeholder="Escibe una nota"
          />

          {mode === 'edit' ? (
            <div className="box-btn-create">
              <button type="submit" className="btn-create" onClick={removeItem}>
                Editar Nota
              </button>
            </div>
          ) : (
