...
describe('contextAuth', ()=> {
    ...
    beforeEach(() => {
        provider = mount(<AuthProvider><AnyComponent email={email} password={password} /></AuthProvider>);
    });
    ...
    test('llamar al metodo createUserWithEmailAndPassword al ejecutar signup',() => {
        ...
        expect(global.firebaseAuth.createUserWithEmailAndPassword).toHaveBeenCalledWith(undefined, email, password);
    });
